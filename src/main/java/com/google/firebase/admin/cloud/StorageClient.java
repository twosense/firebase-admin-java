...
package com.google.firebase.admin.cloud;
 ...
 * storage bucket via {@link FirebaseOptions}, and then get a reference to this
...
public class StorageClient {
   ...
   * configured via {@link FirebaseOptions} when initializing the app. If

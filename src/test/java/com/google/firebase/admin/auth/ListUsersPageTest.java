...
public class ListUsersPageTest {
  ...
  public void testMultiplePages() throws FirebaseAuthException, IOException {
    ListUsersPage.ListUsersResult result = new ListUsersPage.ListUsersResult(
    ...
    result = new ListUsersPage.ListUsersResult(
  ...
  private static class TestUserSource implements ListUsersPage.UserSource {
    ...
    private ListUsersPage.ListUsersResult result;
    ...
    TestUserSource(int userCount) throws IOException {
      ...
      this.result = new ListUsersPage.ListUsersResult(users.build(), ListUsersPage.END_OF_LIST);
    }

    TestUserSource(ListUsersPage.ListUsersResult result) {
      this.result = result;
    }

    @Override
    public ListUsersPage.ListUsersResult fetch(int maxResults, String pageToken) {
      calls.add(pageToken);
      return result;
    }
  }

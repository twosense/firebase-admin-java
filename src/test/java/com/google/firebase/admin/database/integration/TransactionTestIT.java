...
import static com.google.firebase.admin.database.TestHelpers.fromSingleQuotedString;
...
import com.google.firebase.admin.database.ChildEventListener;
...
import com.google.firebase.admin.database.EventRecord;
import com.google.firebase.admin.database.FirebaseDatabase;
import com.google.firebase.admin.database.MapBuilder;
import com.google.firebase.admin.database.MutableData;
import com.google.firebase.admin.database.ServerValue;
import com.google.firebase.admin.database.TestChildEventListener;
import com.google.firebase.admin.database.TestFailure;
...
import com.google.firebase.admin.database.core.AuthTokenProvider;
import com.google.firebase.admin.database.core.DatabaseConfig;
import com.google.firebase.admin.database.core.RepoManager;
import com.google.firebase.admin.database.future.ReadFuture;
import com.google.firebase.admin.database.future.WriteFuture;
import com.google.firebase.admin.testing.IntegrationTestUtils;
...
public class TransactionTestIT {
  ...
  public void testSetCancelAlreadySentTransactions()
    ...
    try {
      ...
      ref.setValue(32, new DatabaseReference.CompletionListener() {
        @Override
  ...
  public void testTransactionsRaiseCorrectChildChangedEventsOnQueries()
    ...
    assertEquals(new MapBuilder().put("value", 1L).build(), addedSnapshot.getValue());
    DataSnapshot changedSnapshot = snapshots.get(1);
    Assert.assertEquals("foo", changedSnapshot.getKey());
    assertEquals(new MapBuilder().put("value", 2L).build(), changedSnapshot.getValue());
